...
这个目录用于收拢公开仓库的说明材料，减少根目录噪音，并为后续更细的项目百科与隐私手册预留稳定入口。  
This directory consolidates the public-repo documentation, keeps the repository root lean, and provides a stable home for deeper encyclopedia-style and privacy-focused guides.
...
- [`OPEN_SOURCE_SPLIT.md`](OPEN_SOURCE_SPLIT.md): 公开仓库导出边界和脱敏策略  
